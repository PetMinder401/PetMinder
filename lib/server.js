...
// require(../route/route-userModel)(router);
// require(../route/route-pet)(router);
// require(../route/route-reminder)(router);
// require(../route/route-medication)(router);
...
server.start = () => {
  return new Promise((resolve, reject) => {
    if(server.isOn) return reject(new Error('Server Error. Cannot start server on same port'));
